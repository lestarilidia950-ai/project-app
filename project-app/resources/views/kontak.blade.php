...
<body class="font-body bg-white">
    ...
    <section class="relative w-full h-[500px] bg-[url('assets/img/latar.png')] bg-cover bg-center flex items-start">
        ...
        <div class="relative container max-w-6xl mx-auto px-6 text-center text-white pt-24 md:pt-32">
            <h1 class="text-5xl md:text-6xl font-black">Kontak</h1>
        </div>
    </section>
    ...
    <section class="w-full py-12 bg-white">
        <div class="container max-w-6xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-10">
                ...
                <div class="space-y-6">
                    <div>
                        <h2 class="text-2xl font-bold text-[#0A400C] mb-2">Terhubung dengan Kami</h2>
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-[#0A400C] mb-2">Media Sosial</h2>
                ...
                <div>
                    <form action="#" method="POST" class="space-y-4">
                        <div>
                            ...
                            <input 
                                type="text" 
                                placeholder="Siapa Pengirim Email ini"
                        ...
                        <div>
                            ...
                            class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-green-500 placeholder-gray-400"></textarea>
                        </div>
