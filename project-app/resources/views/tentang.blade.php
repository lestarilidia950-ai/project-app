...
<body class="font-body bg-white">
  ...
  <section class="relative w-full h-[300px] sm:h-[400px] md:h-[500px] bg-[url('assets/img/latar.png')] bg-cover bg-center flex items-center">
    ...
    <div class="relative container max-w-6xl mx-auto px-4 sm:px-6 text-center text-white">
      <h1 class="text-3xl sm:text-4xl md:text-6xl font-black">Ingin Tahu Kami?</h1>
    </div>
  </section>

  <!-- Latar Belakang -->
  <section class="w-full py-10 bg-white">
    <div class="container max-w-6xl mx-auto px-4 sm:px-6 text-left">
      <h5 class="text-lg sm:text-xl font-bold text-[#1E392A] mb-3">Latar Belakang</h5>
  ...
  <section class="w-full py-10 bg-white">
    <div class="container max-w-6xl mx-auto px-4 sm:px-6 text-left">
      <h5 class="text-lg sm:text-xl font-bold text-[#1E392A] mb-3">Sejarah Singkat</h5>
      <p class="text-justify text-base leading-relaxed">
      ...
      <p class="text-justify text-base leading-relaxed mt-3">
